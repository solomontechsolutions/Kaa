  ...
  return (
    <div className="shell py-24 lg:py-28">
      ...
      <p className="mt-5 text-lg leading-relaxed text-foreground-muted">
        ...
        launch. They will cover the tenant subscription, Kaa&rsquo;s rental service charge, listing
        standards, field agent conduct, dispute resolution and the limits of Kaa&rsquo;s role in a
        tenancy.
      </p>
